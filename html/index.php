    ...
    <div class="container font">
    	<div class="row">
    		<div class="col-6" Style="">
    			<h1 class="font">1 on 1 Tutoring</h1>
    		...
    		<div class="row font">
    			<div class="col-6">
    				<h1 class="font">Our Process & Philosophy</h1>
    		...
    		<div class="row">
    			<div class="col-12 bg-info" Style="border-radius:30px">
    				...
    				<h1 class="font">Schedule a Free Consultan Today!</h1>
    				<div class="row">
    				<div class="col-8"><p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, nde omnis iste natus error sit voluptatem accusantium doloremque laudantium</p></div>
    				<div class="col-4">
    					<button class="btn btn-primary rounded-pill" type="submit">Go Check</button>
    				</div>
    				</div>
    		...
    		<div class="row row-cols-3">
  				...
  				<div class="col" align="center" style="">
  					<img src="img/3.jpg" class="img-thumbnail rounded-circle" width="200px">
  			...
  			<div class="row" align="center" style="">
  				<div class="col">
  					<h1 class="font">Let's Learn Together!</h1>
  					<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam</p>
  				</div>
  				<div class="row">
     					<div class="col" align="center" Style="">
 			 ...
 			 <div class="footer">
 			 	<img src="img/5.jpg" class="position:absolute" width="100%">
 			 </div>
    	</div>
